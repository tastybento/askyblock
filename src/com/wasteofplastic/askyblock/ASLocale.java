...
public class ASLocale {
    ...
    public void loadLocale() {
        ...
        igs.put(SettingsFlag.INTERACT_TAMED, ChatColor.translateAlternateColorCodes('&', locale.getString("islandguardsettings.interacttamed", "Visitors can interact with tamed animals")));
