...
public class InventorySave {
	...
	// Else Clear - NO DO NOT CLEAR - this will clear all inventories if
	// player dies and override server
     ...
     */
    /*
     * public void switchPlayerInventory(Player player, Location from, Location
     * to) {
