...
public class PlayerIsland implements Island {
    ...
    public PlayerIsland(String serial) {
     ...
     * @param minZ
     */
    public PlayerIsland(int x, int z) {
    ...
    public PlayerIsland(int x, int z, UUID owner) {
	// Calculate min minX and z
	this.minX = x - Settings.islandDistance / 2;
	this.minZ = z - Settings.islandDistance / 2;
	this.minProtectedX = x - Settings.island_protectionRange / 2;
     ...
     * @param votes
     */
    public PlayerIsland(int x, int z, int protectionRange, Location center, UUID owner, long createdDate, long updatedDate, String password, int votes) {
	this.minX = x - Settings.islandDistance / 2;
	this.minZ = z - Settings.islandDistance / 2;
	this.minProtectedX = x - Settings.island_protectionRange / 2;
	this.minProtectedZ = z - Settings.island_protectionRange / 2;
