            ...
            case 1:
                if (split[0].equalsIgnoreCase("make")) {
                    ...
                    if (VaultHelper.checkPerm(player, Settings.PERMPREFIX + "island.lang")) {
                        ...
                        player.sendMessage("FranÃ§ais");
                        player.sendMessage("Deutsch");
                        player.sendMessage("EspaÃ±ol");
                        player.sendMessage("Italiano");
                        player.sendMessage("?•œêµ??˜ / Korean");
                        player.sendMessage("Polski");
                        player.sendMessage("Brasil");
                        player.sendMessage("ä¸??›½ / Chinese");
                        player.sendMessage("ÄŒeÅ¡tina");
                        player.sendMessage("SlovenÄina");
                    } else {
            ...
            case 2:
                if (split[0].equalsIgnoreCase("make")) {
                    ...
                    if (VaultHelper.checkPerm(player, Settings.PERMPREFIX + "island.lang")) {
                        ...
                        } else if (split[1].equalsIgnoreCase("FranÃ§ais") || split[1].equalsIgnoreCase("Francais")) {
                        ...
                        } else if (split[1].equalsIgnoreCase("espaÃ±ol") || split[1].equalsIgnoreCase("espanol")) {
                        ...
                        } else if (split[1].equalsIgnoreCase("Korean") || split[1].equalsIgnoreCase("?•œêµ??˜")) {
                        ...
                        } else if (split[1].equalsIgnoreCase("Chinese") || split[1].equalsIgnoreCase("ä¸??›½")) {
                            plugin.getPlayers().setLocale(playerUUID, "zh-CN");
                        } else if (split[1].equalsIgnoreCase("ÄŒeÅ¡tina") || split[1].equalsIgnoreCase("Cestina")) {
                            plugin.getPlayers().setLocale(playerUUID, "cs-CS");
                        } else if (split[1].equalsIgnoreCase("SlovenÄina") || split[1].equalsIgnoreCase("Slovencina")) {
